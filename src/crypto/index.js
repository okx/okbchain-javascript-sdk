...
/**
 * entry: ex -> 0x
 * covert address from bech32 to 0x format
 * @param {string} address with bech32 format
 * @returns {String} address with hex format
 */
